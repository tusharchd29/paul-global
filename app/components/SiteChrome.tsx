  ...
  <footer className="site-footer">
   <div className="container">
    <div className="footer-main">
     <div className="footer-brand"><Link href="/" className="footer-logo"><img src="/logo/lockup-white.png" width="176" height="104" alt="Paul Global"/></Link><p>Engineered for performance.<br/>Backed by technical collaboration. Built for global markets.</p><a href="mailto:exports@paulglobal.com" className="footer-email">exports@paulglobal.com</a><span>Chandigarh, India</span></div>
     <div className="footer-column"><h4>Explore</h4><Link href="/">Home</Link><Link href="/products">Products</Link><a href="/#technical">Technical Capability</a><a href="/#manufacturing">Partnership</a><a href="/#markets">Global B2B</a></div>
    ...
    <div className="footer-bottom"><span>© 2026 Paul Global. All rights reserved.</span><span>Animal Nutrition · Technical Collaboration · Global Export</span><a href="#top">Back to top ↑</a></div>
   </div>
  </footer>
